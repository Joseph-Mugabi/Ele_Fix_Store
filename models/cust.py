...
from sqlalchemy import Column, String, Table, Integer, ForeignKey, Text, text
...
if models.storage_t == "db":
    customer_item = Table("customers_items", BaseModel.metadata,
                          Column("customer_id", String(60)),
                          ForeignKey("customers.id", onupdate="CASCADE",
                                     ondelete="CASCADE"),
                          primary_key=True), Column("item_id", String(60),
                                                    ForeignKey("items.id",
                                                    onupdate="CASCADE",
                                                    ondelete="CASCADE",
                                                    primary_key=True))
